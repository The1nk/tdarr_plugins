...
const details = () => ({
  id: 'Tdarr_Plugin_The1nk_MC93_Migz1FFMPEG_CPU',
  Stage: 'Pre-processing',
  Name: 'The1nk Migz Transcode Using CPU & FFMPEG and add tag',
  Type: 'Video',
  Operation: 'Transcode',
  Description: `Files not in H265 will be transcoded into H265 using CPU with ffmpeg.
                ...
                The1nk's version: Also adds a tag to the file after processing so that it won't be re-processed on each cycle.`,
  Version: '1.9',
